...
def compact_record(source: dict[str, Any], item_type: str, group: str, semantic: dict[str, dict[str, Any]], abstracts: dict[str, str]) -> dict[str, Any]:
    ...
    return {
        ...
        "embeddingClusterId": semantic_fields.get("embeddingClusterId"),
        "embeddingClusterLabel": semantic_fields.get("embeddingClusterLabel"),
        "embeddingClusterSize": semantic_fields.get("embeddingClusterSize"),
        "embeddingClusterKeywords": semantic_fields.get("embeddingClusterKeywords", []),
        "embeddingClusterMethod": semantic_fields.get("embeddingClusterMethod"),
