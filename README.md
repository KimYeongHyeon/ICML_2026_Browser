...
The checked-in artifact is generated by chunking the full study index and attempting every eligible record. The current public artifact covers 7,066 study records, with parseable bibliographies for 3,116 records, 46,981 extracted reference strings, and 39,918 normalized unique reference keys. Records without reachable PDFs, blocked sources, malformed PDFs, or parseable bibliography sections remain represented as unmatched rather than silently omitted.
